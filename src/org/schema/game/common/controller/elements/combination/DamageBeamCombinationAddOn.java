/*
 * DamageBeamCombinationAddOn.java (modified)
...
public class DamageBeamCombinationAddOn extends BeamCombinationAddOn<DamageBeamUnit, DamageBeamCollectionManager, DamageBeamElementManager> {
    ...
    private static final MultiConfigModifier<BeamUnitModifier<DamageBeamUnit>, DamageBeamUnit, BeamCombiSettings> beamPlasmaUnitModifier = new MultiConfigModifier<BeamUnitModifier<DamageBeamUnit>, DamageBeamUnit, BeamCombiSettings>() {
        @Override
        public BeamUnitModifier<DamageBeamUnit> instance() {
            return new BeamUnitModifier<>();
        }
    ...
    @Override
    protected BeamUnitModifier getBeamPlasmaUnitModifier() {
        return beamPlasmaUnitModifier.get(elementManager);
    }
}