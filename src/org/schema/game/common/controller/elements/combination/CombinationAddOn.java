...
//					System.err.println("CHECKING: "+item.getNodeName()+" -> "+f.getName()+"; "+(annotation != null ? annotation.name() : "NoAnnotation(null)"));
    ...
    public Modifier<E, S> getGUI(CM fireingCollection, E firingUnit, ControlBlockElementCollectionManager<?, ?, ?> combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        ...
        if (combi instanceof WeaponCollectionManager) {
            return getGUI(fireingCollection, firingUnit, (WeaponCollectionManager) combi, effectCollectionManager);
        ...
        } else if (combi instanceof PlasmaLauncherCollectionManager) {
            return getGUI(fireingCollection, firingUnit, (PlasmaLauncherCollectionManager) combi, effectCollectionManager);
        } else {
            return null;
        }
    }
    public double calculatePowerConsumptionCombi(double powerPerBlock, CM fireingCollection, E firingUnit, ControlBlockElementCollectionManager<?, ?, ?> combi,
        ...
        if (combi instanceof WeaponCollectionManager) {
            return calcCannonCombiPowerConsumption(powerPerBlock, fireingCollection, firingUnit, (WeaponCollectionManager) combi, effectCollectionManager);
        } else if (combi instanceof DamageBeamCollectionManager) {
            ...
            return calcPlasmaCombiPowerConsumption(powerPerBlock, fireingCollection, firingUnit, (PlasmaLauncherCollectionManager) combi, effectCollectionManager);
        }
    ...
    public double calculateReloadCombi(CM fireingCollection, E firingUnit, ControlBlockElementCollectionManager<?, ?, ?> combi,
                                       ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        if (combi instanceof WeaponCollectionManager) {
            return calcCannonCombiReload(fireingCollection, firingUnit, (WeaponCollectionManager) combi, effectCollectionManager);
        } else if (combi instanceof DamageBeamCollectionManager) {
            ...
            return calcPlasmaCombiReload(fireingCollection, firingUnit, (PlasmaLauncherCollectionManager) combi, effectCollectionManager);
        }
        throw new RuntimeException("Invalid Combination "+fireingCollection+"; "+firingUnit+"; "+combi+"; "+effectCollectionManager);
    }
    public abstract double calcCannonCombiPowerConsumption(double powerPerBlock, CM fireingCollection, E firingUnit, WeaponCollectionManager combi,
                                                           ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
    ...
    public abstract double calcMissileCombiPowerConsumption(double powerPerBlock, CM fireingCollection, E firingUnit, DumbMissileCollectionManager combi,
                                                            ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
    public abstract double calcPlasmaCombiPowerConsumption(double powerPerBlock, CM fireingCollection, E firingUnit, PlasmaLauncherCollectionManager combi,
                                                           ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);

    public abstract double calcCannonCombiReload(CM fireingCollection, E firingUnit, WeaponCollectionManager combi,
                                                 ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
    ...
    public abstract double calcPlasmaCombiReload(CM fireingCollection, E firingUnit, PlasmaLauncherCollectionManager combi,
                                                  ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);

    public void calcCombiSettings(S out, CM fireingCollection, ControlBlockElementCollectionManager<?, ?, ?> combi,
                                  ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        if (combi instanceof WeaponCollectionManager) {
            calcCannonCombiSettings(out, fireingCollection, (WeaponCollectionManager) combi, effectCollectionManager);
            return;
        } else if (combi instanceof DamageBeamCollectionManager) {
            ...
            calcPlasmaCombiPowerSettings(out, fireingCollection, (PlasmaLauncherCollectionManager) combi, effectCollectionManager);
            return;
        }
        throw new RuntimeException("Invalid Combination "+fireingCollection+"; "+combi+"; "+effectCollectionManager);
    }

    public abstract void calcCannonCombiSettings(S out, CM fireingCollection, WeaponCollectionManager combi,
                                                 ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
    ...
    public abstract void calcPlasmaCombiPowerSettings(S out, CM fireingCollection, PlasmaLauncherCollectionManager combi,
                                                       ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
    ...
    public ShootingRespose handle(CM fireingCollection, E firingUnit, ControlBlockElementCollectionManager<?, ?, ?> combi,
        ...
        if (firingUnit instanceof FireingUnit && !(firingUnit instanceof BeamUnit<?, ?, ?>) && !((FireingUnit<?, CM, EM>) firingUnit).canUse(firingUnit.getSegmentController().getState().getUpdateTime(), true)) {
            return ShootingRespose.RELOADING;
        }

        if (combi instanceof WeaponCollectionManager) {
            return handleCannonCombi(fireingCollection, firingUnit, (WeaponCollectionManager) combi, effectCollectionManager, shootContainer, lockOntarget, playerState, timer, beamTimeout);
        } else if (combi instanceof DamageBeamCollectionManager) {
            ...
            return handlePlasmaCombi(fireingCollection, firingUnit, (PlasmaLauncherCollectionManager) combi, effectCollectionManager, shootContainer, lockOntarget, playerState, timer, beamTimeout);
        } else {
    ...
    public abstract ShootingRespose handleCannonCombi(CM fireringCollection, E firingUnit, WeaponCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager, ShootContainer shootContainer, SimpleTransformableSendableObject lockOntarget, PlayerState playerState, Timer timer, float beamTimeout);
    ...
    public abstract ShootingRespose handlePlasmaCombi(CM fireringCollection, E firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager, ShootContainer shootContainer, SimpleTransformableSendableObject lockOntarget, PlayerState playerState, Timer timer, float beamTimeout);

    public abstract Modifier<E, S> getGUI(CM fireringCollection, E firingUnit, WeaponCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
    ...
    public abstract Modifier<E, S> getGUI(CM fireringCollection, E firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager);
}