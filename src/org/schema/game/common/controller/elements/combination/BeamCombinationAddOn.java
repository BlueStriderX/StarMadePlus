/*
 * BeamCombinationAddOn.java (modified)
...
//		}
    ...
    protected abstract BeamUnitModifier getBeamPlasmaUnitModifier();
    ...
    @Override
    public ShootingRespose handlePlasmaCombi(CM fireringCollection, E firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager, ShootContainer shootContainer, SimpleTransformableSendableObject lockOntarget, PlayerState playerState, Timer timer, float beamTimeout) {
        return handle(getBeamPlasmaUnitModifier(), fireringCollection, firingUnit, combi, effectCollectionManager, shootContainer, lockOntarget, playerState, timer, beamTimeout);
    }
    ...
    @Override
    public Modifier<E, BeamCombiSettings> getGUI(CM fireringCollection, E firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        BeamUnitModifier mod = getBeamPlasmaUnitModifier();
        mod.handle(firingUnit, combi, getRatio(fireringCollection, combi));
        return mod;
    }
    ...
    @Override
    public double calcPlasmaCombiPowerConsumption(double powerPerBlock, CM fireingCollection, E firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        return getBeamPlasmaUnitModifier().calculatePowerConsumption(powerPerBlock, firingUnit, combi, getRatio(fireingCollection, combi));
    }
    ...
    @Override
    public double calcPlasmaCombiReload(CM fireingCollection, E firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        return getBeamPlasmaUnitModifier().calculateReload(firingUnit, combi, getRatio(fireingCollection, combi));
    }
    ...
    @Override
    public void calcPlasmaCombiPowerSettings(BeamCombiSettings out, CM fireingCollection, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        getBeamPlasmaUnitModifier().calcCombiSettings(out, fireingCollection, combi, getRatio(fireingCollection, combi));
    }
}