/*
 * MissileCombinationAddOn.java (modified)
...
//	public static final MultiConfigModifier<MissileUnitModifier<DumbMissileUnit>, DumbMissileUnit> missilePulseUnitModifier = new MultiConfigModifier<MissileUnitModifier<DumbMissileUnit>, DumbMissileUnit>() {
//
//		@Override
//		public MissileUnitModifier<DumbMissileUnit> instance() {
//			return new MissileUnitModifier();
...
//	};
    ...
    public static final MultiConfigModifier<MissileUnitModifier<DumbMissileUnit>, DumbMissileUnit, MissileCombiSettings> missilePlasmaUnitModifier = new MultiConfigModifier<MissileUnitModifier<DumbMissileUnit>, DumbMissileUnit, MissileCombiSettings>() {
        @Override
        public MissileUnitModifier<DumbMissileUnit> instance() {
            return new MissileUnitModifier<>();
        }
    ...
    public ShootingRespose handle(MissileUnitModifier mod, DumbMissileCollectionManager fireringCollection,
        ...
        if (fireringCollection.getSegmentController().isOnServer()) {
            ...
            for (int i = 0; i < mod.outputSplit; i++) {
                ...
                }else if(effectCollectionManager instanceof PlasmaLauncherCollectionManager) {
                    elementManager.getMissileController().addHeatMissile(
                            fireringCollection.getSegmentController(),
                            transform,
                            dir,
    ...
    public ShootingRespose handleCannonCombi(
            ...
            DumbMissileUnit firingUnit, WeaponCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager,
    ...
    @Override
    public ShootingRespose handlePlasmaCombi(DumbMissileCollectionManager fireringCollection, DumbMissileUnit firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager, ShootContainer shootContainer, SimpleTransformableSendableObject lockOntarget, PlayerState playerState, Timer timer, float beamTimeout) {
        return handle(missilePlasmaUnitModifier.get(combi), fireringCollection, firingUnit, combi, effectCollectionManager, shootContainer, lockOntarget);
    }
    ...
    @Override
    public Modifier<DumbMissileUnit, MissileCombiSettings> getGUI(DumbMissileCollectionManager fireringCollection, DumbMissileUnit firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        MissileUnitModifier mod = missilePlasmaUnitModifier.get(combi);
        mod.handle(firingUnit, combi, getRatio(fireringCollection, combi));
        return mod;
    }
    ...
    public double calcCannonCombiPowerConsumption(double powerPerBlock, DumbMissileCollectionManager fireingCollection,
                                                  DumbMissileUnit firingUnit, WeaponCollectionManager combi,
                                                  ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        MissileUnitModifier mod = missileCannonUnitModifier.get(combi);
    ...
    @Override
    public double calcPlasmaCombiPowerConsumption(double powerPerBlock, DumbMissileCollectionManager fireingCollection, DumbMissileUnit firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        return missilePlasmaUnitModifier.get(combi).calculatePowerConsumption(powerPerBlock, firingUnit, combi, getRatio(fireingCollection, combi));
    }
    ...
    @Override
    public double calcPlasmaCombiReload(DumbMissileCollectionManager fireingCollection, DumbMissileUnit firingUnit, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        return missilePlasmaUnitModifier.get(combi).calculateReload(firingUnit, combi, getRatio(fireingCollection, combi));
    }
    ...
    @Override
    public void calcPlasmaCombiPowerSettings(MissileCombiSettings out, DumbMissileCollectionManager fireingCollection, PlasmaLauncherCollectionManager combi, ControlBlockElementCollectionManager<?, ?, ?> effectCollectionManager) {
        missilePlasmaUnitModifier.get(combi).calcCombiSettings(out, fireingCollection, combi, getRatio(fireingCollection, combi));
    }
}
